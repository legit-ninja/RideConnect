...
from sqlalchemy import Boolean, DateTime, Enum, ForeignKey, Integer, SmallInteger, Text, UniqueConstraint, func
...
class Review(Base):
    ...
    observed_rider_skill: Mapped[int | None] = mapped_column(SmallInteger, nullable=True)
